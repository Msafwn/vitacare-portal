...
export const Route = createFileRoute("/admin/notifications")({
  head: () => ({
    meta: [
      { title: "Notifications & Broadcasts — LifeDrop Admin" },
      {
        name: "description",
        content: "Send targeted donor broadcasts and review system notification activity.",
      },
      { property: "og:title", content: "Notifications & Broadcasts — LifeDrop Admin" },
      { property: "og:description", content: "Broadcast alerts to donors by group and city." },
    ],
  }),
