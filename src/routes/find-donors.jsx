...
export const Route = createFileRoute("/find-donors")({
  head: () => ({
    meta: [
      { title: "Find Blood Donors by Group & City — LifeDrop" },
      {
        name: "description",
        content:
          "Search LifeDrop's verified donor registry by blood group, city and availability to find a match fast.",
      },
      { property: "og:title", content: "Find Blood Donors by Group & City — LifeDrop" },
      { property: "og:description", content: "Filter verified donors by group, city and status." },
    ],
  }),
