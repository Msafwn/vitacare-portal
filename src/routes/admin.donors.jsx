...
export const Route = createFileRoute("/admin/donors")({
  head: () => ({
    meta: [
      { title: "Donor Registry — LifeDrop Admin" },
      {
        name: "description",
        content: "Verify donors, review availability and monitor donation frequency across cities.",
      },
      { property: "og:title", content: "Donor Registry — LifeDrop Admin" },
      { property: "og:description", content: "Verify and monitor the donor registry." },
    ],
  }),
