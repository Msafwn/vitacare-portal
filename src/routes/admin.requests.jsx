...
export const Route = createFileRoute("/admin/requests")({
  head: () => ({
    meta: [
      { title: "Blood Requests — LifeDrop Admin" },
      {
        name: "description",
        content: "Approve, reject and prioritise incoming blood requests from hospitals and families.",
      },
      { property: "og:title", content: "Blood Requests — LifeDrop Admin" },
      { property: "og:description", content: "Approve and prioritise incoming blood requests." },
    ],
  }),
