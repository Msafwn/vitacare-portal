...
export const Route = createFileRoute("/admin/settings")({
  head: () => ({
    meta: [
      { title: "Admin Settings — LifeDrop" },
      {
        name: "description",
        content: "Configure platform thresholds, admin team access and notification defaults.",
      },
      { property: "og:title", content: "Admin Settings — LifeDrop" },
      { property: "og:description", content: "Platform thresholds and admin team access." },
    ],
  }),
