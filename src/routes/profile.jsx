...
export const Route = createFileRoute("/profile")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Update your donor profile: blood group, city, contact details and availability.",
      },
      { property: "og:title", content: "My Profile — LifeDrop" },
      { property: "og:description", content: "Manage your donor details and availability." },
    ],
  }),
  component: Profile,
});
