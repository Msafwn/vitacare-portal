...
export const Route = createFileRoute("/admin/reports")({
  head: () => ({
    meta: [
      { title: "Reports & Analytics — LifeDrop Admin" },
      {
        name: "description",
        content: "Donation trends, fulfilment rates and city-level performance reports for the network.",
      },
      { property: "og:title", content: "Reports & Analytics — LifeDrop Admin" },
      { property: "og:description", content: "Donation trends and fulfilment analytics." },
    ],
  }),
