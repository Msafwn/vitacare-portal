...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About LifeDrop — Our Mission for Safe Blood" },
      {
        name: "description",
        content:
          "Learn how LifeDrop builds a verified, transparent blood donor network connecting hospitals, donors and patients.",
      },
      { property: "og:title", content: "About LifeDrop — Our Mission for Safe Blood" },
      {
        property: "og:description",
        content: "A verified, transparent blood donor network for hospitals and patients.",
      },
    ],
  }),
  component: About,
