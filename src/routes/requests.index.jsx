...
export const Route = createFileRoute("/requests/")({
  head: () => ({
    meta: [
      { title: "My Blood Requests — LifeDrop" },
      {
        name: "description",
        content: "Track the status of every blood request you have raised on LifeDrop.",
      },
      { property: "og:title", content: "My Blood Requests — LifeDrop" },
      { property: "og:description", content: "Monitor pending, approved and fulfilled requests." },
    ],
  }),
