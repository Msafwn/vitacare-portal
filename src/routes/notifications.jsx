...
export const Route = createFileRoute("/notifications")({
  head: () => ({
    meta: [
      { title: "Notifications — LifeDrop" },
      {
        name: "description",
        content: "Donor matches, request updates and eligibility reminders in one place.",
      },
      { property: "og:title", content: "Notifications — LifeDrop" },
      { property: "og:description", content: "Matches, request updates and reminders." },
    ],
  }),
