...
export const Route = createFileRoute("/admin/login")({
  head: () => ({
    meta: [
      { title: "Admin Login — LifeDrop Control Panel" },
      {
        name: "description",
        content: "Secure sign-in for LifeDrop administrators managing donors, requests and inventory.",
      },
      { property: "og:title", content: "Admin Login — LifeDrop Control Panel" },
      { property: "og:description", content: "Secure administrator access to the LifeDrop panel." },
    ],
  }),
